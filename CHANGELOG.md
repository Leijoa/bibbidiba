...
### 0天賦模擬測試與數值追蹤 (Baseline Simulation)
* **10萬次模擬結果**：以無靈魂奉獻狀態進行了 10 萬次模擬，第 10 層（創世神）的通關率約為 0.24%。
* **各層通關率**：第1層(100%)、第3層(68%)、第6層(8.4%)、第9層(0.76%)、第10層(0.24%)。
* **各層平均傷害**：第1層約 1,772，第3層約 2,754，第6層約 11,015，第10層約 389,938。
* **強弱勢排名**：最強勢牌型為「三同」與「小葫蘆」；最常獲得遺物為「大一」到「大八」系列。
* **枷鎖致死率**：最危險的枷鎖前五名為【孤立無援】(84%)、【剝削】(83%)、【平庸之惡】(80%)、【忘卻】(73%)、【秩序崩壞】(71%)。
* **總體產出**：平均獲得 131 金幣與 4.1 個遺物，最高爆發傷害達 16 億。模擬器已能正確觸發【再生】級別的融合遺物。
