...
export const ENEMY_DB = [
    ...
    { name: '巨石傀儡 (菁英)', hp: 7000, turns: 3 },           // Stage 3 (Index 2)
    { name: '幽暗衛士', hp: 8500, turns: 3 },                  // Stage 4 (Index 3)
    { name: '吸血鬼男爵', hp: 13000, turns: 3 },               // Stage 5 (Index 4)
    { name: '深淵魔龍 (菁英)', hp: 48000, turns: 3 },          // Stage 6 (Index 5)
    { name: '墮落天使', hp: 47000, turns: 3 },                 // Stage 7 (Index 6)
    { name: '虛空行者', hp: 75000, turns: 3 },                 // Stage 8 (Index 7)
    { name: '混沌騎士 (菁英)', hp: 430000, turns: 3 },         // Stage 9 (Index 8)
    { name: '創世神 (最終Boss)', hp: 1300000, turns: 3 },      // Stage 10 (Index 9)
];
