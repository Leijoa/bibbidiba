...
export const RELIC_DB = [
    ...
    { id: 'piggybank', name: '【存錢筒】', desc: '每次擊敗敵人獲得 5 枚金幣。', price: 15, rarity: 2 },
    ...
    { id: 'bounty', name: '【賞金獵人】', desc: '若能在「1 回合內」秒殺敵人，額外獲得 10 金幣。', price: 25, rarity: 2 },
    { id: 'coin', name: '【幸運金幣】', desc: '結算時獲得金幣 +10', price: 20, rarity: 3 },
    ...
    { id: 'vip', name: '【VIP會員】', desc: '商店內所有遺物的價格降低 10%（向下取整）。', price: 30, rarity: 3 },
    ...
    { id: 'fusion_recycle', name: '【回收領主】', desc: '刷新商店價格-3，最低1金幣。且你在商店購物時享有 30% 折扣。', price: 0, rarity: 5 },
    { id: 'fusion_fortune', name: '【五福中天】', desc: '4, 5 的倍率隨「5 的出現次數」累計成長。每出現過一次 5，倍率 +0.05x。', price: 0, rarity: 5 },
    { id: 'fusion_miser', name: '【黃金守財奴】', desc: '每回合結束時，根據持有金幣獲得「複利」傷害加成。', price: 0, rarity: 5 },
