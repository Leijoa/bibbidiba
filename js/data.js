...
export const RELIC_DB = [
    ...
    { id: 'scavenger', name: '【拾荒者】', desc: '在商店刷新商品的價格-2金幣。第一次免費以外，最低1金幣。', price: 20, rarity: 1 },
    ...
    { id: 'piggybank', name: '【存錢筒】', desc: '每次擊敗敵人獲得 5 枚金幣。', price: 25, rarity: 2 },
    ...
    { id: 'investor', name: '【投資達人】', desc: '戰鬥結算時，每持有 10 枚金幣，就額外獲得 1 枚金幣利息', price: 35, rarity: 2 },
    { id: 'arithmetic', name: '【等差數列】', desc: '盤面上每多一種「不同的數字」，最終結算的基礎點數總和 +8。', price: 35, rarity: 2 },
    { id: 'bounty', name: '【賞金獵人】', desc: '若能在「1 回合內」秒殺敵人，額外獲得 10 金幣。', price: 35, rarity: 2 },
    { id: 'coin', name: '【幸運金幣】', desc: '結算時獲得金幣 +10', price: 30, rarity: 3 },
    ...
    { id: 'allin', name: '【孤注一擲】', desc: '當玩家 HP 只剩 1 時，最終傷害 x2.5', price: 40, rarity: 3 },
    ...
    { id: 'vip', name: '【VIP會員】', desc: '商店內所有遺物的價格降低 10%（向下取整）。', price: 40, rarity: 3 },
    ...
    { id: 'goldendice', name: '【黃金骰子】', desc: '每次發動攻擊時，盤面每有一顆 7，立即獲得 3 金幣', price: 50, rarity: 4 },
    ...
    { id: 'bankrupt', name: '【破財消災】', desc: '承受致命傷害時，若金幣 ≥ 100，扣除【所有金幣】並保留 1 HP（每局限一次）。', price: 80, rarity: 4 },
    ...
    { id: 'fusion_peak', name: '【登峰造極】', desc: '7, 8 點數隨「目前持有的金幣」成長（每 15 金幣，基礎點數 +3）。', price: 0, rarity: 5 },
